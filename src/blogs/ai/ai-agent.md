...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421727.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421729.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421730.png)

大模型的一些关键特点：

**① 参数数量**：大模型通常拥有数百万甚至数十亿个参数，这些参数在训练过程中不断调整以更好地拟合数据；

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421731.png)
```
GPT-4参数约1.76T
GPT-4o参数约200B
GPT-4o mini参数约8B
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421732.png)

- **语言大模型（NLP）**：是指在自然语言处理领域中的一类大模型，通常用于处理文本数据和理解自然语言。这类大模型的主要特点是它们在大规模语料库上进行了训练，以学习自然语言的各种语法、语义和语境规则。

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421733.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181355837.png)

- **模型开发(Developing Models)** 

从模型架构和训练过程上改善，一般是更多的参数、更好的数据质量。一些关键词：**解码策略 、知识图谱 、监督微调**等。

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181358295.png)
### 智能体（AI Agent）
**智能体**（Intelligent Agent）是一个计算机科学和人工智能领域的概念，它指的是一个能够感知其环境并作出行动以实现某些目标或任务的系统。智能体可以是软件或硬件，或者是两者的结合。

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421734.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421735.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181418745.png)

国内智能体构建平台举例：

- [coze](https://www.coze.cn/)

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421736.png)

- [文心智能体平台](https://agents.baidu.com/center)

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421738.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421739.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421740.png)

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421741.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501130005262.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421742.png)

- 安装 llama
```bash
ollama run llama3.2
```
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421743.png)

- 服务器模式启动大模型
```bash
ollama serve
```
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421744.png)

**② 搭建本地LLM交互界面**
- 安装 anythingllm

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421745.png)

- 模型配置

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421746.png)

- 导入本地文档

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421747.png)

- 开始智能问答

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421748.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421749.png)

**② 大模型Key配置**

大模型推荐使用[DeepSeek-V3](https://mp.weixin.qq.com/s/iFZOQsUNkpkXPDvOkE99wQ)，国产开源，物美价廉，生成效果堪比主流闭源（吃草挤奶）。

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421750.png)

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421751.png)

**③ 扩展配置**

主要是文件读取、编辑，命令执行，浏览器和MCP等使用权限设置。

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421752.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421753.png)

- 任务完成信息

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421754.png)

- 生成效果查看

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421755.png)

- 提交修改意见并等待编码完成

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421756.png)

- 验收效果

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421757.png)

**案例2：代码重构 & 单侧生成**

- 打开已有代码或项目并提交重构诉求

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421758.png)

- 提交单侧生成诉求

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421759.png)

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421760.png)

- 基于运行报错修改单侧代码

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421761.png)

将报错信息对话框发送给Cline用于修改代码。

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421762.png)

- 运行单侧

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421763.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421764.png)

- 代码自动生成

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421765.png)

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421766.png)

- 运行查看效果

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421767.png)

真的，除了价格都挺美丽。

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421768.png)

## 启示
既见未来，为何不拜。

![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/202501181421769.png)
