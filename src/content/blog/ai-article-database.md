...
tags:
  ...
  - "自动化"
draft: false
originalPath: "/blogs/ai/ai-article-database.html"
---
...
![](/images/blog/ai-article-database/20260123000703645-85847a4b.png)
...
![](/images/blog/ai-article-database/20260123000703648-1e18f129.png)
...
![](/images/blog/ai-article-database/20260123000703652-1bbd6d93.png)
...
![](/images/blog/ai-article-database/20260123000703653-fcbf575c.png)

![](/images/blog/ai-article-database/20260123000703654-85d46580.png)

省略迭代交互，最后AI给的架构图如下：

![](/images/blog/ai-article-database/20260123001006076-3a1839e6.png)
...
![](/images/blog/ai-article-database/20260123000703655-1bd6fbef.png)

- **步骤二**：使用`SOLO Coder`模式实现MVP版本

![](/images/blog/ai-article-database/20260123000703656-673c7609.png)

建议开启`Plan`，模型会优先规划，用户确认后再执行，可以有效减少生成代码不符合预期的情况。

![](/images/blog/ai-article-database/20260123000703657-58074ac9.png)

TRAE的执行计划会保存到`.trae/documents`下，这种处理方式非常实用，既方便人工审查，也便于在切换任务后读取。

![](/images/blog/ai-article-database/20260123000703658-f374921b.png)

之后就是等待智能体完成代码编写。当然AI声称的完成状态大概率是不可信的，通常无法正常运行或遗漏了部分功能实现，但至少完成了整个项目的骨架，这样我们就进入迭代完善环节了。

![](/images/blog/ai-article-database/20260123000703659-837ac924.png)
#### 迭代完善
...
![](/images/blog/ai-article-database/20260123000703660-4ac8c5aa.png)

![](/images/blog/ai-article-database/20260123000703661-25ad045d.png)

- **步骤二**：部署并验收结果

![](/images/blog/ai-article-database/20260123000703662-36bc9c6e.png)

- **步骤三**：使用AI生成`git commit`内容并提交代码

![](/images/blog/ai-article-database/20260123132713531-9ea8e2b9.png)

![](/images/blog/ai-article-database/20260123000703664-f46241fc.png)
