...
![](/images/blog/mac-terminal/202411271838726-c770a9a7.png)
#### 常用命令
```bash
# 查看配置
brew config
...
![](/images/blog/mac-terminal/202411271841097-2a561f81.png)
#### 个性化设置
可以在Settings中进行个性化配置，如字体、背景、快捷键等，笔者一般情况下直接使用默认配置。

![](/images/blog/mac-terminal/202411271847191-214cb330.png)
### 第三步：安裝 zsh
更多安装信息可以访问[Installing ZSH](https://github.com/ohmyzsh/ohmyzsh/wiki/Installing-ZSH)。
```bash
brew install zsh
```
![](/images/blog/mac-terminal/202411271851444-0efe98d5.png)
### 第四步：安装 Oh My Zsh 并配置
#### 安装命令
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)"
```
![](/images/blog/mac-terminal/202411271907948-96ec4c4b.png)
#### 个性化配置
- **别名配置**
...
![](/images/blog/mac-terminal/202411271939377-90ec32c0.png)

![](/images/blog/mac-terminal/202411271942728-60078bea.png)
...
![](/images/blog/mac-terminal/202411272009329-889c5c14.png)

**③ z**

官方插件，开启方式同上。跟踪最常访问的目录，能够通过输入所需目录路径中的几个字符来**快速访问**。

![](/images/blog/mac-terminal/202411272030894-d6a1455b.png)

![](/images/blog/mac-terminal/202411272013222-29dbfc31.png)
...
![](/images/blog/mac-terminal/202411272038502-e76e94c3.png)
...
![](/images/blog/mac-terminal/202411272029765-039c5fe2.png)
...
![](/images/blog/mac-terminal/202411272055083-47de852f.png)
## 结语
