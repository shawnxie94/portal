...
![](/images/blog/read-code-tools/202501251329061-a06a6d9e.png)
...
![](/images/blog/read-code-tools/202501251329652-67e4d819.png)
...
![](/images/blog/read-code-tools/202501251330987-bae5ea2d.png)

**②代码检查**：对于语法格式和样式进行检查；

![](/images/blog/read-code-tools/202501251330517-0adfdb49.png)

**③代码探索**：查看函数和变量的使用位置；

自动显示对函数、变量、类等的引用，使用高级搜索功能在整个项目中进行搜索。

![](/images/blog/read-code-tools/202501251331414-6df9f4b3.png)

**④对比分析**：提供了多维度对比分析能力。

- 文件对比

![](/images/blog/read-code-tools/202501251331930-93efa64e.png)

- 目录对比

![](/images/blog/read-code-tools/202501251332499-c32e7e43.png)

还有其他功能，有兴趣的同学可以自行探索一下。
### [Understand](https://scitools.com/)
![](/images/blog/read-code-tools/202501251332435-0484591a.png)

Understand使用静态代码分析技术，提供了多个维度的代码分析结果展示，其核心功能和SI类似但更丰富，而且工具易用性更好，也支持多种操作系统。

**①代码可视化**：提供各种图形可视化能力，包括依赖关系图，CallGraph，CFG、UML等等；

![](/images/blog/read-code-tools/202501251332494-4eb5d7de.png)

- 控制流程图（CFG）

![](/images/blog/read-code-tools/202501251333764-29872225.png)
...
![](/images/blog/read-code-tools/202501251334245-2967513a.png)

**⑤代码变更分析**：快速查看两个项目代码之间的差异。
可以按文件、文件夹、实体或架构维度查看变更。只需要指定要对比的git版本或要对比的两个数据库，便可以以文本或树形图对比的形式查看变更情况。

![](/images/blog/read-code-tools/202501251335732-e1e3631f.png)
...
![](/images/blog/read-code-tools/202501251335890-1639545a.png)
